                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-12 mx-auto my-4" id="s_register">
                        <form action="Update_Data.php" method="POST" enctype="multipart/form-data">
                            <h3 class="text-center text-capitalize my-2">Question Update Form</h3>
                            <br>
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-10">
                                    <select id="inputState" name="uni_name" class="form-control">
                                      <?php  
                                            ...
                                            $sql = "SELECT uni_name FROM university WHERE 1";
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-4">
                                  <?php
                                     ...
                                     if($result1->num_rows > 0){
                                           $row = $result1->fetch_assoc();
                                           echo '<input type="number" class="form-control" name="year" value='.$row['year'].' placeholder="Enter year" required>';       
                                      }
                                  ?>
                                </div>
                            </div>
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-10">
                                    <select class="form-control" name="Uploded_by" required>
                                    <?php
                                      $sql = "SELECT * FROM university_questions WHERE q_id='$id'";
                                      ...
                                      if($result1->num_rows > 0){
                                            $row = $result1->fetch_assoc();
                                            $techer = $row['uploaded_by'];
                                      }
                                      $sql = "SELECT * FROM teacher WHERE t_id='$techer'";
                                      ...
                                      {
                                        while($row = $result->fetch_assoc()){
                                          echo '<option value='.$row['t_id'].'>'.$row['email'].'<option>';
                                        }  
                                      }
                            ...
                            <div class="form-row">
                                ...
                                <?php
                                     ...
                                     if($result1->num_rows > 0){
                                           $row = $result1->fetch_assoc();
                                           echo '<input type="date" class="form-control" name="date_upload" value='.$row['date_uploaded'].' required>';       
                                      }
                                  ?>
