    ...
    <body>
        <header>
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
                <a class="navbar-brand text-capitalize"><b>Student Deatil</b></a>
                ...
                if($result->num_rows){
                    ...
                    echo '  <div class="my-3 text-center">
                            ...
                            <div class="form-row my-2">
                                ...
                                <div class="col">
                                    <input class="form-control" type="text" value="'.$row['s_name'].'" readonly>
                                </div>
                            </div>
                            ...
                            <div class="form-row mb-2">
                                ...
                                <div class="col">
                                    <input class="form-control" type="text" value="'.$row['s_address'].'" readonly>
                                </div>
                            </div>
                        ';
                }
