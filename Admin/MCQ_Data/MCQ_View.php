            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav ml-auto">
                <li class="nav-item active">
                  <a class="nav-link" href="../Admin_start.php">Home</a>
                </li>
                <li class="nav-item">
                  <form class="form-inline my-2 my-lg-0" action="" method="POST">
                      <input class="form-control mr-sm-2" type="text" name="MCQ_data" placeholder="MCQ Search" aria-label="Search">
                      <button class="btn btn-info my-2 my-sm-0" type="submit" name="MCQ_search"><i class="fa fa-search" aria-hidden="true"></i></button>
                  </form>
                </li>
              </ul>
            </div>
                        ...
                        <?php
                            ...
                            if(isset($_SESSION['user_pass'])){
                                ...
                                if(isset($_POST['MCQ_search'])){
                                  $search = ucwords($_POST['MCQ_data']);

                                  $sql = "SELECT * FROM mcq_question WHERE m_subject = '$search' OR m_question = '$search' OR explantion = '$search' OR m_id='$search'";
                                  ...
                                  $sql = "SELECT * FROM mcq_question WHERE 1";
