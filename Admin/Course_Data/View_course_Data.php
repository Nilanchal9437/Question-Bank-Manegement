                                        ...
                                        <div class="col-lg-6 col-md-6 col-12 mx-auto my-4" id="s_register">
                                            ...
                                            <form>
                                                <div class="form-row my-2">
                                                    ...
                                                    <div class="col">
                                                        <input class="form-control" type="text" value="'.$course.'" readonly>
                                                    </div>
                                                </div>
                                                <div class="form-row mb-2">
                                                    ...
                                                    <div class="col">
                                                        <input class="form-control" type="text" value="'.$branch.'" readonly>
                                                    </div>
                                                </div>
                                                <div class="form-row mb-2">
                                                    <div class="col">
                                                    ...
                                                    <div class="col">
                                                        <input class="form-control" type="text" value="'.$subject.'" readonly>
                                                    </div>
                                                </div>
                                            </form>
