...
<body>
    <header>
      <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <a class="navbar-brand text-capitalize" href="index.html"><b><i class="fa fa-user" aria-hidden="true"></i> Teacher Detail's </b></a>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item active">
                <form class="form-inline my-2 my-lg-0" action="" method="POST">
                    <input class="form-control mr-sm-2" type="text" name="teacher_search" placeholder="Search" aria-label="Search">
            ...
            <div class="row">
                <div class="col-lg-7 col-md-12 col-12 mx-auto my-4" id="s_register">
                    <div class="my-3 text-center">
                        <h1><i class="fa fa-users" aria-hidden="true"></i> Teacher Detail's </h1>
                    </div>
                    <div id="scroll_question" class="mb-2">
                       <table class="table table-striped">
                            <thead class="bg-info text-white text-center">
                                ...
                                <th scope="col">Teacher Name's</th>
                            ...
                            <tbody>
                                <?php
                                   ...
                                   if(isset($_SESSION['user_pass']))
                                   {
                                        ...
                                        {
                                            $Serach_Bar = ucwords($_POST["teacher_search"]);

                                            $sql = "SELECT * FROM teacher WHERE t_id='$Serach_Bar' OR t_name='$Serach_Bar' OR gender='$Serach_Bar'";
                                            ...
                                            if($result->num_rows > 0){
                                                while($row = $result->fetch_assoc()){
                                                    echo "<tr>
                                                            ...
                                                            <td class='25' >".$row['t_name']."</td>
                                                            <td>".$row['gender']."</td>
                                                            <td>".$row['mobile']."</td>
                                                            <td class='text-center'>
                                                                <a type='button' class='btn btn-success' href='./View_T_Data.php?id=$row[t_id]' ><i class='fa fa-eye fa-1x' aria-hidden='true'></i></a>                        
                                                                <a type='button' class='btn btn-warning' href='./Update.php?id=$row[t_id]' ><i class='fa fa-pencil fa-1x' aria-hidden='true'></i></a>
                                                                <a type='button' class='btn btn-danger' onclick='return check()' href='./Delete.php?id=$row[t_id]' ><i class='fa fa-trash fa-1x' aria-hidden='true'></i></a>
                                                                <a type='button' class='btn btn-dark' href='./Password.php?id=$row[t_id]' ><i class='fa fa-eye-slash' aria-hidden='true'></i></a>                        
                                                            </td>
                                                        </tr>";
                                                }
                                            }
