...
<body>
    <header>
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <a class="navbar-brand text-capitalize"><b> Teacher Profile Update </b></a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav ml-auto">
                <li class="nav-item active">
                  <a class="nav-link" href="../Teacher_Login.php"><i class="fa fa-home" aria-hidden="true"></i>Home <span class="sr-only">(current)</span></a>
                </li>
              </ul>
            </div>
          </nav>
                                ...
                                <form action="Profile_Update_data.php" method="POST">
                                    ...
                                    <div class="form-row mb-4">
                                       <div class="form-group col-md-12 text-center">
                                            <button type="submit" name="UPDATE_TEACHER" class="btn btn-warning my-1"><i class="fa fa-pencil fa-1x" aria-hidden="true"></i> UPDATE</button>
                                            <a href="../Teacher_Login.php"><button type="button" class="btn btn-secondary my-1"><i class="fa fa-sign-out" aria-hidden="true"></i> BACK</button></a>
                                            <a type="button" onclick="return check()" class="btn btn-danger my-1"  href="./Profile_Delete.php"><i class="fa fa-trash fa-1x" aria-hidden="true"></i> DELETE</a>
                                            <a type="button" class="btn btn-dark my-1" href="./Profile_Password.php" ><i class="fa fa-eye-slash" aria-hidden="true"></i> PASSWORD</a>                        
                                        </div>    
                                    </div>
                                </form>
                            </div>
...
?>
  ...
  <section>
    ...
    <script>
       function check(){
           var data = confirm("Are you sure you want to Delete Your Profile Forever");
           if(data){
               return true;
           }
           else{
