              ...
              <?php
                    ...
                    if(isset($_SESSION['user_id']))
                    {
                        ...
                        if($result->num_rows > 0){
                            ...
                            echo '<li class="nav-item active">
                                    <a class="nav-link"> WELCOME  <i class="fa fa-user-circle-o" aria-hidden="true"></i> '.$user.'</a>
                                  </li>';
                        }
                    }
                    else{
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="./Question/Upload.php">Question Upload</a>
                        <a class="dropdown-item" href="./Question/View.php">Question View</a>
                        <a class="dropdown-item" href="./Question/MCQ_Upload.php">MCQ Upload</a>
                        <a class="dropdown-item" href="./Question/MCQ_View.php">MCQ View</a>
                    </div>
                </li>
                <li class="nav-item">
