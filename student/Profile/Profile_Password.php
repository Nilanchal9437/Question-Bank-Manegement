            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav ml-auto">
                <li class="nav-item active">
                  <a class="nav-link" href="./Profile_Update.php"><i class="fa fa-home" aria-hidden="true"></i>Home <span class="sr-only">(current)</span></a>
                </li>
              </ul>
            </div>
          </nav>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-12 mx-auto my-4 text-center" id="s_register">
                    <form onsubmit="return validation()" action="Password_Update.php" method="POST">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-10">
                                <input type="password" class="form-control" name="old_password" id="password_id" required>
                            </div>
                        </div>
                        ...
                        <span style="color: red;">
                            <?php
                                ...
                                {
                                    if($_GET['error'] == "true"){
                                        echo "<small> Your old password not match </small>";
                                    }
                                    else{
                                        echo "";
                                    }   
                        ...
                        <div class="text-center my-2 pb-4">
                            ...
                            <a href="./Profile_Update.php"><button type="button" class="btn btn-secondary">Back</button></a>
                        </div>
                    </form>
                </div>
            </div>
