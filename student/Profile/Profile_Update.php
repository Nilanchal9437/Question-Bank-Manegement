            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav ml-auto">
                <li class="nav-item active">
                  <a class="nav-link" href="../Student_View.php"><i class="fa fa-home" aria-hidden="true"></i>Home <span class="sr-only">(current)</span></a>
                </li>
              </ul>
            </div>
          </nav>
                                ...
                                <form action="Profile_Update_data.php" method="POST">
                                    ...
                                    <div class="form-row mb-4">
                                       <div class="form-group col-md-12 text-center">
                                            ...
                                            <a href="../Student_View.php"><button type="button" class="btn btn-secondary my-1"><i class="fa fa-sign-out" aria-hidden="true"></i> BACK</button></a>
